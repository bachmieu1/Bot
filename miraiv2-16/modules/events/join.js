...
module.exports.run = async function({ api, event,Threads }) {
	...
	if  (checkban.includes(checkban[0])) return
		...
		return api.sendMessage(`Kết nối thành công với bot của NaCl vui lòng sử dụng ${global.config.PREFIX}help để xem toàn bộ lệnh của bot. Vui lòng sử dụng bot cẩn thận, ko spam lệnh, ko chửi bot. Ai vi phạm sẽ bị ban bằng cách ko đc xài bot. Ai có nhu cầu tạo ib Zalo:0355779130 nha! Ưu tiên mấy bẹn nữ chưa có ny <3`, threadID);
	}
	else {
		try {
